...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(i){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("ember-test/app").default.create({name:"ember-test",version:"0.0.0+8415d7f4"})
